          ...
          switch (_context.prev = _context.next) {
            case 0:
              handleOutgoing = function handleOutgoing(event, next) {
                ...
                if (!_lodash2.default.isNil(fromNumber)) {
...
function _processOutgoing(_ref) {
  ...
  function isImageLink(url) {
    return _lodash2.default.startsWith(url, 'http') && (_lodash2.default.endsWith(url, 'jpg') || _lodash2.default.endsWith(url, 'jpeg') || _lodash2.default.endsWith(url, 'gif') || _lodash2.default.endsWith(url, 'png'));
  }

  if (!_lodash2.default.isNil(instruction.text) || !_lodash2.default.isNil(instruction.image)) {
    ...
    var msgType = !_lodash2.default.isNil(mediaUrl) ? 'image' : 'text';
